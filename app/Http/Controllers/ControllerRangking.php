    ...
    public function index($nama){
        ...
        if($nama=='produksi'){
            ...
            if(count($sql) ==0){
                ...
                $kosong = 0;
                return view('rangking',['a'=>$bagian,'kosong'=>$kosong,'tgl'=>$tgl]);
            }else{
                $k = array();
                for($i=0;$i<4;$i++){
                $a=$i+1;
                ...
                //     // return  redirect('/home');
                // }
                return view('rangking',['sql'=>$sql,'tesw'=>$kedisiplinan,'tespraktik'=>$tespraktik,'a'=>$bagian,'kosong'=>$kosong,'tgl'=>$tgl]);
            }
            ...
            if(count($sql) == 0){
                // echo 'aa';
                $kosong = 0;
                return view('rangking',['sql'=>$sql,'a'=>$bagian,'kosong'=>$kosong,'tgl'=>$tgl]);
            }else{
                ...
                return view('rangking',['sql'=>$sql,'tesw'=>$teswawancara,'test'=>$testulis,'psikotes'=>$psikotes,'a'=>$bagian,'kosong'=>$kosong,'tgl'=>$tgl]);
            }
            
        }

    }
    public function cari(Request $request,$nama){
